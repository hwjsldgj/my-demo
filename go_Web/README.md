...
一个基于 **C++** 和 **ONNX Runtime** 的围棋 AI 对战平台，支持 9×9 和 19×19 棋盘，提供多种 AI 难度级别，并配有简洁的 Web 可视化界面。
...
| 4 | 困难 (MCTS) | 蒙特卡洛树搜索 + 神经网络 | 仅 19×19，需 ONNX 模型；9×9 时自动降级为难度3 |
...
1. **原创部分**：本目录下由我（[你的GitHub用户名]）原创的代码和文档，采用 **CC0 1.0 Universal** 许可，放弃所有版权，贡献至公共领域。你可以自由使用，无需署名。详见根目录 [LICENSE](../LICENSE)。
2. **第三方部分**：本目录若包含引用的第三方开源代码片段，其版权归原作者所有，适用其原有许可证（已在代码头部注明）。
